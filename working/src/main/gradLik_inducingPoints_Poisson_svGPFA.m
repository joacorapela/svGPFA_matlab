...
mu_h = varargin{1};
var_h = varargin{2};
% start modified by Joaco 09/03/19
q_mu = varargin{3};
q_sigma = varargin{4};
...
% start modified by Joaco 09/03/19
% [ddk_mu_in,ddk_sig_in] = grads_inducingPoints_posteriorGP(m,Kmats,trEval,R);
[ddk_mu_in,ddk_sig_in] = grads_inducingPoints_posteriorGP(m,Kmats,q_mu,q_sigma,R);
% end modified by Joaco 09/03/19

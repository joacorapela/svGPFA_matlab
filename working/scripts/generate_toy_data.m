...
% sps  {NxM} cell       -- spike train for each of the N neurons, M trials
Y = cell(ntr,1);
for nn = 1:ntr; Y{nn} = sps(:,nn);end % this is just to keep things consitent with other inputs
% Y{trial} cell array of length nNeurons. Y{trialX}{neuronY} contains the spike
% times of neuronY in trialX
